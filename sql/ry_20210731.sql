...
create table sys_dept (
  ...
  primary key (dept_id)
) engine=innodb default charset utf8 auto_increment=200 comment = '部门表';
...
create table sys_role (
  ...
  remark               varchar(500)    default null               comment '备注',
  primary key (role_id)
) engine=innodb default charset utf8 auto_increment=100 comment = '角色信息表';
...
create table sys_oper_log (
  ...
  primary key (oper_id)
) engine=innodb default charset utf8 auto_increment=100 comment = '操作日志记录';
...
) engine=innodb default charset utf8 auto_increment=100 comment = '参数配置表';
...
) engine=innodb default charset utf8 auto_increment=100 comment = '定时任务调度表';
...
) engine=innodb default charset utf8 auto_increment=10 comment = '通知公告表';
...
) engine=innodb default charset utf8 auto_increment=1 comment = '代码生成业务表';
...
) engine=innodb default charset utf8 auto_increment=1 comment = '代码生成业务表字段';